...
### 2. CTA buttons — link to eToro
- The "Trade" button on each affected asset should deep-link to eToro
- Use the format: https://www.etoro.com/markets/{asset-symbol} (e.g. https://www.etoro.com/markets/gold, https://www.etoro.com/markets/spx500)
- The "Watchlist" button should link to: https://www.etoro.com/watchlists
- Map asset names to eToro market slugs (S&P 500 → spx500, Gold → gold, Oil → oil, Tesla → tsla, etc.)
- Add the eToro logo or "on eToro" label next to the buttons so users know where they're going
- Buttons should open in a new tab (target="_blank")

### 3. Event Detail Page — Combine historical matches into one insight
...
### 4. Event Detail Page — Show affected assets prominently
...
- CTAs ("Trade", "Watchlist") tied to specific assets linking to eToro
